...
/**
 * A standard Button GUI element that can be clicked to perform an action or set
 * of actions.
 *
 * @author Paul Speed
 */
public class Button extends Label {
    ...
    /**
     * Can be called by application code to simulate a click on a button. Note: this
     * will run the click effects/actions but not the press/release actions.
     */
    public void click() {
        runClick();
    }
