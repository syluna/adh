package fr.adh.client.gui.handler;
...
public class ClampDragHandler extends DefaultCursorListener {
    ...
    public ClampDragHandler(boolean clampToCameraLimits) {
        this.clampToCameraLimits = clampToCameraLimits;
    }

    /**
     * Sets the function that will be used to find the draggable spatial relative to
     * the spatial that was clicked. By default, this is the identity() function and
     * will return the spatial that was clicked.
     */
    ...
    /**
     * Finds the draggable spatial for the specified capture spatial. By default
     * this just returns the capture because the parentLocator function is the
     * identity function. This can be overridden by specifying a different function
