...
public class LandscapeManager implements ActionListener {
    ...
    public void addEntity(int idEntity) {
        Player entity = new Player(application.getAssetManager(), spawnPoint);
        bulletAppState.getPhysicsSpace().add(entity.getControl());
    ...
    public void removeEntity(int idEntity) {
        ...
        bulletAppState.getPhysicsSpace().remove(entity.getControl());
