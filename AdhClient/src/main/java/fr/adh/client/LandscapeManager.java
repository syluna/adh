...
public class LandscapeManager implements ActionListener {
    ...
    public void create(@Nonnull Node rootNode, @Nonnull final BitmapFont guiFont) {
        ...
        matRock.setTexture("AlphaMap", application.getAssetManager().loadTexture("Textures/Terrain/splat/alphamap.png"));
        ...
        Spatial sky = SkyFactory.createSky(application.getAssetManager(),
        ...
        water.setFoamTexture((Texture2D) application.getAssetManager().loadTexture("Common/MatDefs/Water/Textures/foam2.jpg"));
    ...
    private void setupKeys() {
        application.getInputManager().addMapping("Strafe Left",
                new KeyTrigger(KeyInput.KEY_Q),
                new KeyTrigger(KeyInput.KEY_Z));
        application.getInputManager().addMapping("Strafe Right",
                new KeyTrigger(KeyInput.KEY_E),
                new KeyTrigger(KeyInput.KEY_X));
        application.getInputManager().addMapping("Rotate Left",
                new KeyTrigger(KeyInput.KEY_A),
                new KeyTrigger(KeyInput.KEY_LEFT));
        application.getInputManager().addMapping("Rotate Right",
                new KeyTrigger(KeyInput.KEY_D),
                new KeyTrigger(KeyInput.KEY_RIGHT));
        application.getInputManager().addMapping("Walk Forward",
                new KeyTrigger(KeyInput.KEY_W),
                new KeyTrigger(KeyInput.KEY_UP));
        application.getInputManager().addMapping("Walk Backward",
                new KeyTrigger(KeyInput.KEY_S),
                new KeyTrigger(KeyInput.KEY_DOWN));
        application.getInputManager().addMapping("Jump",
                new KeyTrigger(KeyInput.KEY_SPACE));
        application.getInputManager().addMapping("Shoot",
        ...
        application.getInputManager().addListener((ActionListener) (String name, boolean isPressed, float tpf) -> {
            if (isPressed) {
                if (name.equals("foam1")) {
                    water.setFoamTexture((Texture2D) application.getAssetManager().loadTexture("Common/MatDefs/Water/Textures/foam.jpg"));
                }
                if (name.equals("foam2")) {
                    water.setFoamTexture((Texture2D) application.getAssetManager().loadTexture("Common/MatDefs/Water/Textures/foam2.jpg"));
                }
                if (name.equals("foam3")) {
                    water.setFoamTexture((Texture2D) application.getAssetManager().loadTexture("Common/MatDefs/Water/Textures/foam3.jpg"));
                }
